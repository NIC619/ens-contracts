...
async function main() {
    ...
    const ensRegiDeployedJson = await utils.getENSRegistryWithFallbackJson()
    ...
    if (network.name === "hardhat") {
        ...
        await impersonateAccount(oriDomainOwnerAddr)
        ...
        await stopImpersonatingAccount(oriDomainOwnerAddr)
